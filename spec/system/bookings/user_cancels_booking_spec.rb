...
describe "Usuário acessa uma reserva" do
  ...
  it "e não cancela a reserva se a data de cancelamento já passou" do
    owner = Owner.create!(
          email: "owner@email.com",
          password: "123456"
    )
    ...
    expect(page).to have_content "Esta reserva não pode mais ser cancelada. Entre em contato com a pousada para mais informações"
  end
end
